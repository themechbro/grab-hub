  ...
  return (
    <div className="relative w-full">
      ...
      <Image
        ...
        width={1920}
        height={400}
        className="w-full h-[50vh] sm:h-[60vh] md:h-[70vh] object-cover rounded-lg"
        priority
      />

      {/* Overlay Card */}
      <div className="absolute top-[50%] left-10 transform -translate-y-1/2 bg-white p-6 rounded-xl shadow-lg w-[90%] sm:w-[60%] md:w-[50%]">
        {/* Rating and Price */}
        <div className="flex items-center gap-2">
          <Star className="text-green-500" size={20} />
          <Typography level="h4" className="font-semibold">
            {restaurant.rating} in Google • ₹{restaurant.cost_for_two} for two
          </Typography>
        </div>
        ...
        {/* Open/Close Status */}
        <Typography level="body-md" className="text-red-500 mt-1">
